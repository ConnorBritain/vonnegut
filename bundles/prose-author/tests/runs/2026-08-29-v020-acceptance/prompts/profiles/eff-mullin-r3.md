...
- uncontracted-negatives -> contraction-negation; section cadence; counted positive.
- first-person-singular-family -> self-reference-biography; section absences; counted absence.
...
- em-dashes -> interruption-punctuation; section cadence; counted positive.
- en-dashes -> interruption-punctuation; section absences; counted absence.

Qualitative dimensions: qualification-hedging, opponents-allies-sources, figures-analogy, openings-endings-closure.
Return 1–5 qualitative observations.
Required unresolved dimensions: profanity-vulgarity.
...
- uncontracted-negatives is not sparse relative to an allowed measured replacement; it is positive and the assembler derives its fixed frequency.
...
- first-person-singular-family is a sparse counterpart and will be an absence with measured replacement first-person-plural-family; the assembler may reuse that positive observation across dimensions.
...
- em-dashes is not sparse relative to an allowed measured replacement; it is positive and the assembler derives its fixed frequency.
- en-dashes is a sparse counterpart and will be an absence with measured replacement em-dashes or round-parenthetical-spans; the assembler may reuse that positive observation across dimensions.
