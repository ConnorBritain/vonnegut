...
- uncontracted-negatives is not sparse relative to an allowed measured replacement; it is positive and must carry one fixed frequency.
...
- em-dashes is not sparse relative to an allowed measured replacement; it is positive and must carry one fixed frequency.
