...
<draft>
For tomorrow’s meeting, the practical answer is no: do not put confidential intake notes into a general AI summarization service. The promised benefit is real—faster review and cleaner handoffs—but the organization would be moving sensitive client histories into a system it doesn’t control.
