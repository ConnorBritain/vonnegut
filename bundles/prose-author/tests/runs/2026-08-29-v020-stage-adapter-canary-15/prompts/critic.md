...
<draft>
Confidential intake notes should not go into a general-purpose AI summariser. The time saved is real, but the proposed shortcut creates a second problem: the service may receive sensitive information the nonprofit holds—names, histories, risks, and requests for help.
