...
<draft>
Using an AI service to summarise confidential intake notes has an obvious appeal: it could save staff time and make tomorrow’s meeting easier to prepare. But the decision turns on control, not convenience. Our recommendation is direct: do not paste those notes into a general-purpose service tomorrow.
