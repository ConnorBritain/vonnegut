...
```json
{
  ...
  "claims": [
    {
      "claim": "Using an AI service to summarise confidential intake notes can save nonprofit staff time.",
      "where": "paragraph 1"
    },
    {
      "claim": "Using an AI service to summarise confidential intake notes can make meeting preparation easier.",
      "where": "paragraph 1"
    },
    {
      "claim": "Confidential nonprofit intake notes may contain names, contact details, health information, legal concerns, or facts about family members.",
      "where": "paragraph 2"
    },
    {
      "claim": "Redacting identifying details and summarising locally from the redacted copy is safer than sending unredacted confidential intake notes to an AI service.",
      "where": "paragraph 4"
    }
  ]
}
