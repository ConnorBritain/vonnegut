...
were not supplied to you as a system prompt, read it first:
    ...
    bundles/prose-review/tests/runs/2026-08-05-fidelity-s4-control/prompts/agent-prompt.md
...
```
  ...
  15 atoms checked, none material-missing. Heading changes are informational.
...
You may read exactly these files, and they are copies staged for this run:
    ...
    bundles/prose-review/tests/runs/2026-08-05-fidelity-s4-control/inputs/case-04/original.md
    bundles/prose-review/tests/runs/2026-08-05-fidelity-s4-control/inputs/case-04/revision.md
