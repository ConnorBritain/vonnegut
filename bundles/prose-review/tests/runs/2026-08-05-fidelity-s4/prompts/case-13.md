...
```
  ...
  8 atoms checked, none material-missing.
...
You may read exactly these files, and they are copies staged for this run:
    ...
    bundles/prose-review/tests/runs/2026-08-05-fidelity-s4/inputs/case-13/original.md
    bundles/prose-review/tests/runs/2026-08-05-fidelity-s4/inputs/case-13/revision.md
