...
```
  ...
  quoted spans absent from the revision:
    "Pompa mortis magis terret, quam mors ipsa."
    "Cogita quamdiu eadem feceris; mori velle, non tantum fortis, aut mi..."
    ...
    "qui finem vitæ extremum inter munera ponit naturæ."
...
You may read exactly these files, and they are copies staged for this run:
    ...
    bundles/prose-review/tests/runs/2026-08-05-fidelity-s4/inputs/case-12/original.md
    bundles/prose-review/tests/runs/2026-08-05-fidelity-s4/inputs/case-12/revision.md
