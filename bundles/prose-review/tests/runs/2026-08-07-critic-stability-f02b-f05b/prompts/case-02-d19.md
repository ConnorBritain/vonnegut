...
were not supplied to you as a system prompt, read it first:
    ...
    bundles/prose-review/tests/runs/2026-08-07-critic-stability-f02b-f05b/prompts/agent-prompt.md
...
```
  ...
  10 atoms checked, none material-missing.
...
You may read exactly these files, and they are copies staged for this run:
    ...
    bundles/prose-review/tests/runs/2026-08-07-critic-stability-f02b-f05b/inputs/case-02/original.md
    bundles/prose-review/tests/runs/2026-08-07-critic-stability-f02b-f05b/inputs/case-02/revision.md
