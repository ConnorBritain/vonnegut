...
were not supplied to you as a system prompt, read it first:
    ...
    bundles/prose-review/tests/runs/2026-08-07-reviser-v3-gate/prompts/agent-prompt.md
...
You may read exactly these files, and they are copies staged for this run:
    ...
    bundles/prose-review/tests/runs/2026-08-07-reviser-v3-gate/inputs/case-11/original.md
    bundles/prose-review/tests/runs/2026-08-07-reviser-v3-gate/inputs/case-11/revision.md
