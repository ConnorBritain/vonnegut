# Dispatching run 2026-08-07-reviser-v3-gate

11 cases × 3 draw(s) = 33 clean-context `fidelity` dispatches.
...
```bash
node tests/run-harness.mjs dispatch tests/runs/2026-08-07-reviser-v3-gate
```
...
```bash
node tests/run-harness.mjs collect tests/runs/2026-08-07-reviser-v3-gate
```
