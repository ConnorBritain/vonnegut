...
were not supplied to you as a system prompt, read it first:
    ...
    bundles/prose-review/tests/runs/2026-08-07-reviser-fidelity-gate/prompts/agent-prompt.md
...
```
  presence check: material atoms missing
  ...
  numbers absent from the revision:
    "1884"

  named entities absent from the revision:
    "University of Moscow"

  Each atom above appeared in the original and does not appear in the revision.
  Some of those losses are intentional (a rewrite may consolidate). The critic that
  reads this decides which - not the scanner.
...
You may read exactly these files, and they are copies staged for this run:
    ...
    bundles/prose-review/tests/runs/2026-08-07-reviser-fidelity-gate/inputs/case-04/original.md
    bundles/prose-review/tests/runs/2026-08-07-reviser-fidelity-gate/inputs/case-04/revision.md
