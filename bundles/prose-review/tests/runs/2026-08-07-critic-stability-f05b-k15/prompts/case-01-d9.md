...
were not supplied to you as a system prompt, read it first:
    ...
    bundles/prose-review/tests/runs/2026-08-07-critic-stability-f05b-k15/prompts/agent-prompt.md
...
You may read exactly these files, and they are copies staged for this run:
    ...
    bundles/prose-review/tests/runs/2026-08-07-critic-stability-f05b-k15/inputs/case-01/original.md
    bundles/prose-review/tests/runs/2026-08-07-critic-stability-f05b-k15/inputs/case-01/revision.md
