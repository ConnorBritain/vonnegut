...
```
  ...
  11 atoms checked, none material-missing.
...
You may read exactly these files, and they are copies staged for this run:
    ...
    bundles/prose-review/tests/runs/2026-08-07-critic-tighten-verify/inputs/case-01/original.md
    bundles/prose-review/tests/runs/2026-08-07-critic-tighten-verify/inputs/case-01/revision.md
