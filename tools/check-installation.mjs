...
const SKILLS = [["prose-author", "prose-draft"], ["prose-author", "prose-style-tune"], ["prose-author", "prose-corpus"], ["prose-author", "prose-repurpose"], ["prose-tell-scan", "tell-scan"], ["prose-outline", "prose-outline"], ["prose-bible", "prose-bible"], ["prose-research", "prose-research"]];
